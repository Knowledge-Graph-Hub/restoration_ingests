...
INGEST_NAME = "data_source, ex. alliance, flybase, or hpoa._type_of_ingest, ex. gene, disease_to_phenotype, or disease_associations."
TRANSFORM_SCRIPT = "./src/restoration_ingests/transform.py"
